...
void RobloxLogs::debug_log(const std::uint64_t address, const char *name)
{
...
std::vector<std::filesystem::path> RobloxLogs::get_roblox_file_logs()
{
...
std::wstring RobloxLogs::get_username()
{
...
std::filesystem::path RobloxLogs::get_latest_log()
{
    ...
    RobloxLogs::debug_log(reinterpret_cast<std::uint64_t>(logs[0].c_str()), "Latest Log Found");
